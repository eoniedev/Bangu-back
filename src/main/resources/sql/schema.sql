...
CREATE TABLE `options` (
  ...
  `opt` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `options_rooms_id_fk` (`room_id`),
  CONSTRAINT `options_rooms_id_fk` FOREIGN KEY (`room_id`) REFERENCES `rooms` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14010 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `rooms` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `rooms_dongcode_1_idx` (`dong_code`),
  CONSTRAINT `rooms_dongcode_1` FOREIGN KEY (`dong_code`) REFERENCES `dongcode` (`dongCode`),
  CONSTRAINT `rooms_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `members` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7558 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
